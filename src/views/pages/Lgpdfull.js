    ...
    return (
        <div className='position-relative  d-flex justify-content-evenly'>
            ...
            <CButtonGroup vertical role="group" aria-label="Vertical button group" className="position-relative gap-1 mt-0 m-3 w-25 text-center d-flex flex-column">
                ...
                <CButton style={{backgroundColor: "#2085c7"}} className=" border border-0 rounded-pill text-white" href="/lgpdfull/quiz">Quiz LGPD <input className="form-check-input " type="checkbox" value={Check} style={{backgroundColor:'#8f9779',borderRadius: '50px',boxShadow:'none'}} onClick={handleCheck} ></input></CButton>
                <CButton style={{backgroundColor: "#2085c7"}} className=" border border-0 rounded-pill text-white" href="/lgpdfull/dpo">DPO <input className="form-check-input " type="checkbox" value={Check} style={{backgroundColor:'#8f9779',borderRadius: '50px',boxShadow:'none'}} onClick={handleCheck} ></input></CButton>
                <CButton style={{backgroundColor: "#2085c7"}} className=" border border-0 rounded-pill text-white" href="/lgpdfull/setor">Setor <input className="form-check-input " type="checkbox" value={Check} style={{backgroundColor:'#8f9779',borderRadius: '50px',boxShadow:'none'}} onClick={handleCheck} ></input></CButton>
                <CButton style={{backgroundColor: "#2085c7"}} className=" border border-0 rounded-pill text-white" href="/lgpdfull/inventario">Inventário <input className="form-check-input " type="checkbox" value={Check} style={{backgroundColor:'#8f9779',borderRadius: '50px',boxShadow:'none'}} onClick={handleCheck} ></input></CButton>
            <br></br>
            <br></br>
            <br></br>
            <br></br>
            ...
            <CButtonGroup vertical role="group" aria-label="Vertical button group" className="position-relative gap-1 mt-0 m-3 w-25 text-center d-flex flex-column">
                ...
                <CButton style={{backgroundColor: "#2085c7"}}  className=" border border-0 rounded-pill text-white" href="/lgpdfull/politica-de-privacidade" >Política de Priv. <input className="form-check-input " type="checkbox" value={Check} style={{backgroundColor:'#8f9779',borderRadius: '50px',boxShadow:'none'}} onClick={handleCheck} ></input></CButton>
                ...
                <CButton style={{backgroundColor: "#2085c7"}} className=" border border-0 rounded-pill text-white" href="/lgpdfull/termos-de-uso" >Termos de Uso <input className="form-check-input " type="checkbox" value={Check} style={{backgroundColor:'#8f9779',borderRadius: '50px',boxShadow:'none'}} onClick={handleCheck} ></input></CButton>
                <CButton style={{backgroundColor: "#2085c7"}} className=" border border-0 rounded-pill text-white" href="/lgpdfull/chacklist/painel-do-checklist" >Checklist de TI <input className="form-check-input " type="checkbox" value={Check} style={{backgroundColor:'#8f9779',borderRadius: '50px',boxShadow:'none'}} onClick={handleCheck} ></input></CButton>
                <CButton style={{backgroundColor: "#2085c7"}} className=" border border-0 rounded-pill text-white" href= "/lgpdfull/politica-de-cookies" >Cookies <input className="form-check-input " type="checkbox" value={Check} style={{backgroundColor:'#8f9779',borderRadius: '50px',boxShadow:'none'}} onClick={handleCheck} ></input></CButton>
