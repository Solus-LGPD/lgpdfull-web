        ...
        <div class='mt-4 m-0'>
            <CForm class='d-flex justify-content-evenly'>
                ...
                <CButtonGroup vertical role="group" aria-label="Vertical button group" class="mt-0 m-3 w-25 text-center d-flex flex-column">
                    <h5 style={{color: "#2085c7", 'font-size': '27px'}} class='p-4pb-1 h5 text-decoration-none ' >FASE DE IMPLEMENTAÇÃO</h5>
                ...
                <h5 style={{color: "#2085c7", 'font-size': '180px'}} class='justify-content-start flex-column h1 d-flex'>C</h5>
                <CButtonGroup vertical role="group" aria-label="Vertical button group" class="mt-0 m-3 w-25 text-center d-flex flex-column">
