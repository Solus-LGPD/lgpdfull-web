    ...
    return (
        <div className=' d-flex justify-content-evenly'>
            ...
            <CButtonGroup vertical role="group" aria-label="Vertical button group" className="gap-1 mt-0 m-3 w-25 text-center d-flex flex-column">
                ...
                <CButton style={{backgroundColor: "#2085c7"}} className=" border border-0 rounded-pill text-white" href="#" disabled>DPO</CButton>
                <CButton style={{backgroundColor: "#2085c7"}} className=" border border-0 rounded-pill text-white" href="#" disabled>Setor</CButton>
                <CButton style={{backgroundColor: "#2085c7"}} className=" border border-0 rounded-pill text-white" href="#" disabled>Inventário</CButton>
            <br></br>
            <br></br>
            <br></br>
            <br></br>
            ...
            <CButtonGroup vertical role="group" aria-label="Vertical button group" className="gap-1 mt-0 m-3 w-25 text-center d-flex flex-column">
                <h5 style={{color: "#2085c7", 'fontSize': '27px'}} className='p-4pb-1 h5 text-decoration-none ' >FASE DE IMPLEMENTAÇÃO</h5>
