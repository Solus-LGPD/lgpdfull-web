    ...
    return (
        <div className='position-relative  d-flex justify-content-evenly'>
            ...
            <CButtonGroup vertical role="group" aria-label="Vertical button group" className="position-relative gap-1 mt-0 m-3 w-25 text-center d-flex flex-column">
                ...
                <CButton style={{backgroundColor: "#2085c7"}} className=" border border-0 rounded-pill text-white" href="/lgpdfull/checklist" >Checklist de TI <input title= {Check ? 'Item realizado' : 'Item a realizar'} className="form-check-input " type="checkbox" value={Check} style={{backgroundColor:'#8f9779',borderRadius: '50px',boxShadow:'none'}} onClick={handleCheck} ></input></CButton>
