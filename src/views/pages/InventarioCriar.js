        ...
        <div>
            <CRow>
                ...
                <CForm class='text-black'>
                    ...
                    <br></br>
                    <CPopover content="Descrever  como (de que forma) os dados  pessoais são coletados.  *MAIÚSCULO e separado por vírgula* Ex.:NOME,CPF,RG,...  "placement="right">
                    ...
                    <br></br>
                    <CPopover content="Selecione a razão ou motivo pela qual se deseja tratar os dados pessoais."placement="right">
                    ...
                    <CFormSelect options={sectorsList} required value={sector} onChange={(e) => setSector(e.target.value)}>
                        ...
                        <option value="1">Consentimento - Mendiante consetimento do titular</option>
                        <option value="2">Regulatório - Para cumprimento de obrigação legal ou regulatória pelo controlador</option>
                        <option value="3">Governo - Pela administração pública, para tratamento de dados necessários a política pública</option>
                        <option value="4">Pesquisa - Para realização de estudos por órgão de pesquisa, sendo garantida a anonimização dos dados</option>
                        <option value="5">Contratos - Quando necessário para a execução de contrato</option>
                        <option value="6">Judicial - Exercício regular de direitos, inclusive em contrato e em processo judicial,administrativo e arbitral</option>
                        <option value="7">Vida - Para a proteção da vida ou incolumidade física do títular ou terceiros</option>
                        <option value="8">Saúde - Para a tutela da saúde, com procedimento realizado por profissionais da área da saúde ou por entidades sanitárias</option>
                        <option value="9">Legítimo interesse - Interesses legítimos do controlador ou de terceiro</option>
                        <option value="10">Crédito - Para proteção do crédito</option>
                        <option value="11">Dados sensíveis - Para garantia da prevenção à fraude e á segurança do títular</option>
                    </CFormSelect>
                    <br></br>
                    <CPopover content="Descrever onde seus dados ficam armazenados. *MAIÚSCULO e separado por vírgula*  Ex.: BANCO DE DADOS, PASTAS FISICAS E EXCEL,... "placement="right">
                    ...
                    <br></br>
                    <CPopover content="Origem dos dados. *MAIÚSCULO e separado por vírgula* Ex.: TITULAR DOS DADOS, FORNECIDO POR TERCEIROS,..."placement="right">
                    ...
                    <br></br>
                    <CPopover content=" Descreva as medidas de segurança usadas para garantir a privacidade dos titulares dos dados. *MAIÚSCULO e separado por vírgula*"placement="right">
                    ...
                    <br></br>
                    <CPopover content="Tempo até o descarte dos dados pessoais. *MAIÚSCULO*"placement="right">
                    ...
                    <br></br>
                    <CPopover content="Razão ou motivo pela qual se deseja tratar os dados pessoais.*MAIÚSCULO*"placement="right">
                    ...
                    <br></br>
                    <br></br>
                    <CPopover content="A quem competem as decisões referentes ao tratamento de dados pessoais. *MAIÚSCULO*"placement="right">
